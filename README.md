...
The analyses included in the paper and the commands used can be found in [paper_analysis.txt](https://github.com/zjjbuqi/HiFiCCL/blob/main/paper_analysis.txt). The assembly results referenced in the manuscript are available on Zenodo and can be accessed using the [DOI: 10.5281/zenodo.17204429](https://doi.org/10.5281/zenodo.17204429).
